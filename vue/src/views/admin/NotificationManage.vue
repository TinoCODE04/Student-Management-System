    ...
    <el-dialog v-model="viewDialogVisible" title="公告详情" width="600px">
      <div class="notification-detail">
        ...
        <div class="meta-info">
          ...
          <el-tag v-else-if="viewData.targetRole === 'teacher'" type="primary">教师</el-tag>
          <el-tag v-else-if="viewData.targetRole === 'student'" type="warning">学生</el-tag>
          <el-tag v-if="viewData.priority === 'high'" type="danger" style="margin-left: 10px">高优先级</el-tag>
          <el-tag v-else-if="viewData.priority === 'medium'" type="warning" style="margin-left: 10px">中优先级</el-tag>
          <el-tag v-else type="info" style="margin-left: 10px">低优先级</el-tag>
          <span style="margin-left: 10px; color: #999;">{{ viewData.createTime }}</span>
        </div>
        <div class="content">
          {{ viewData.content }}
        </div>
